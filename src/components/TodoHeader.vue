<template>
   <div>
    ...
    <ul> 
        ...
        <router-link to="/logout" class="btn btn-light" tag="button" v-if="isLogin()">로그아웃</router-link>
        <router-link to="/login"  class="btn btn-light" tag="button" v-else>로그인</router-link>
